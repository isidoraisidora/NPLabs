...
public class HospitalDemo {
    public static void main(String[] args) {
        ...
        Supplier<Doctor> doctorSupplier = () -> {
            ...
            int licence = Integer.parseInt(parts[0]);
            String name = parts[1];
            int level = Integer.parseInt(parts[2]);
            int numPatients = Integer.parseInt(parts[3]);
            return new Doctor(licence, name, level, numPatients);
        };
        ...
        System.out.println("\n=== All Doctors ===");
        Consumer<Doctor> printDoctor = d -> System.out.println(d);
        ...
        Doctor[] passing = er.evaluate(highExpertise);
        ...
        Doctor chief = er.findFirst(r->r.getLevel()==10);
        ...
        er.mutate(r->r.setLevel(Math.min(r.getLevel()+1,10)));
        er.forEach(System.out::println);
        ...
        er.conditionalMutate(r->r.getPatients()>=30,r->r.setLevel(Math.min(r.getLevel()+1,10)));
        //er.forEach(System.out::println);
